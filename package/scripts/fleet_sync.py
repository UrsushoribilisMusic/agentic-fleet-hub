...
def main():
    ...
    # Write to temp file
    temp_mc = "/Users/miguelrodriguez/fleet/gem/MISSION_CONTROL_SYNCED.md"
    with open(temp_mc, "w") as f:
        f.write(new_content)
    
    print(f"{temp_mc} generated.")
    
    # 5. Apply changes
    print(f"To apply changes, run: cp {temp_mc} {MC_PATH}")
