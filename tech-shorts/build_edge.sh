...
card("hookA.png",[("THE AI BOOM",WHITE,big,0.28),("IS A BET",RED,big,0.28+big/H+0.02),("Hundreds of billions in data centers",MUTE,sm,0.60)])
card("hookB.png",[("Inference is moving to the edge.",WHITE,med,0.34),("On your phone. Not the cloud.",WHITE,med,0.34+med/H+0.02),("Why the data-center boom may crack",TEAL,sm,0.60)])
