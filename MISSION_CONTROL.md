...
| :--- | :--- | :--- | :--- | :--- |
| **#119** | [UI] Strip emojis from /demo dashboard menu | gemma | merged | Gemma, please fix the encoding issues in the demo ... |
| **#120** | [Dashboard] Fix Standups and Inbox rendering in /fleet | misty | merged | Misty, the /fleet dashboard is not showing standup... |
| **#120** | [Dashboard] Fix Standups and Inbox rendering in /fleet | misty | merged | Misty, the /fleet dashboard is not showing standup... |
