...
- **h6xy2yt7**: [ATF] Rebuild QA grounding from canonical RobotRoss sources and ledger data -- ## Context -- Gem. Approved.
...
| **vttdwgaa** | [Ops] Canonize Clau runtime wrapper and summarize_session entrypoint | clau | planned | Problem: Clau found that the deployed runtime copi... |
| **#146** | [Ops] Canonize Clau runtime wrapper and summarize_session entrypoint | clau | merged | Created from GitHub issue #146. Canonize Clau runt... |
