...
- **2beleu6g**: [ATF] Review delivered demo wiki, landing, and ledger surfaces -- Summary -- Gem. Approved.
...
- **#145**: [ATF-8] Build local model runtime adapter for Gemma/Apertus -- Runtime adapter verification and cleanup after prior ticket drift. -- Clau. Approved. -- Gem. Approved.
...
| :--- | :--- | :--- | :--- | :--- |
| **r6pc52qv** | [bug] Demo page: 404 on /fleet/api/config/demo | gem | merged | The demo dashboard is empty because the node server does not handle the /fleet/api/config/demo endpo... |
